...
The [provider-tempoplane](https://github.com/crossplane/provider-tempoplane) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-tempoplane](https://github.com/crossplane-contrib/provider-jet-tempoplane) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-tempoplane/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-tempoplane/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-tempoplane/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-tempoplane/blob/main/hack/boilerplate.go.txt)
...
The [provider-tempoplane](https://github.com/crossplane/provider-tempoplane)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-tempoplane/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-tempoplane/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue tempoplanes (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-tempoplane/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request TempoPlanes: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-tempoplane/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
