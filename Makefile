...
XPKGS = provider-tempoplane
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-tempoplane: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider TempoPlane CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider TempoPlane controllers
...
# This target prepares repo for your provider by replacing all "tempoplane"
